...
@Component({
  ...
  templateUrl: './input-culture.component.html',
  styleUrl: './input-culture.component.css',
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => InputCultureComponent),
      multi: true,
    },
  ],
})
export class InputCultureComponent implements ControlValueAccessor {
  @Input() id = '';
  @Input() name = '';
  @Input() label = '';
